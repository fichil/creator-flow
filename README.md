...
其中 Topic Candidate、Script Draft 和 Storyboard 的生成与选择已在 v0.2 中以本地 fake provider 形式实现；v0.3 已完成 fake render job、fake preview manifest metadata 展示、fake subtitle draft 和 subtitle cues 的 RC 收口；v0.4 已完成 ContentPlan、GenerationSchedule、fake manual GenerationRun 和 Review Draft placeholder 的 RC 收口；v0.5 已完成 PublishIntent / PublicationRecord 后端基础、confirm workflow foundation、fake publisher execution foundation、项目详情页本地 fake publishing workflow 和 RC checklist 收口。真实 AI、真实字幕文件、真实音频、素材方案、真实 MP4 渲染与播放、真实 OAuth、真实上传、真实发布、token 保存、自动发布、排期发布、真实 Douyin API、真实 PublisherProvider、scheduled GenerationRun、Scheduler / Trigger Engine、完整 Review Queue 和指标回流仍属于后续计划方向。
