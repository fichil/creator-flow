...
Batch 10 当前边界：v1.0 已推进到 user test readiness / release candidate package。本批新增 ADR 0055、RC checklist、release notes draft、PR description draft、user test guide、rollback / disablement runbook、RC test matrix 和验证脚本，但不是正式 release tag，也不创建 `v1.0.0`。本次 RC closure audit 仅补充 review / tag / merge readiness 材料，不创建或修改任何 tag。本批仍不启用 `douyin_real`，不允许 fallback 到 `douyin_sandbox`，不调用 Douyin，不查询真实 Douyin 状态，不查询真实 Douyin 指标，不上传、不发布、不排期发布，不创建 OAuth URL，不新增 OAuth start/callback route，不交换 token，也不保存 token / secret / credential / authorization code / raw OAuth state / provider response / upload response / publish response / status response / metrics response / external response / Douyin response material。详见 ADR 0055、[`docs/releases/v1.0-user-test-rc-checklist.md`](docs/releases/v1.0-user-test-rc-checklist.md)、[`docs/releases/v1.0-rc-closure-audit.md`](docs/releases/v1.0-rc-closure-audit.md)、[`docs/releases/v1.0-tag-readiness-checklist.md`](docs/releases/v1.0-tag-readiness-checklist.md)、[`docs/releases/v1.0-merge-readiness-checklist.md`](docs/releases/v1.0-merge-readiness-checklist.md)、[`docs/releases/v1.0-user-test-release-notes-draft.md`](docs/releases/v1.0-user-test-release-notes-draft.md)、[`docs/releases/v1.0-pr-description-draft.md`](docs/releases/v1.0-pr-description-draft.md)、[`docs/testing/v1.0-user-test-guide.md`](docs/testing/v1.0-user-test-guide.md)、[`docs/operations/v1.0-user-test-rollback-disablement.md`](docs/operations/v1.0-user-test-rollback-disablement.md) 和 [`docs/testing/v1.0-user-test-rc-test-matrix.md`](docs/testing/v1.0-user-test-rc-test-matrix.md)。v1.0 不是 production-ready、commercial-ready 或 SaaS-ready，v1.5 / v2.0 仍是后续路线目标。
...
v0.9 Batch 9 的 release / PR merge preparation ADR 见 [`docs/decisions/0044-v0.9-release-merge-preparation.md`](docs/decisions/0044-v0.9-release-merge-preparation.md)，PR 描述草案见 [`docs/releases/v0.9-pr-description-draft.md`](docs/releases/v0.9-pr-description-draft.md)，release notes 草案见 [`docs/releases/v0.9-release-notes-draft.md`](docs/releases/v0.9-release-notes-draft.md)，merge readiness checklist 见 [`docs/releases/v0.9-merge-readiness-checklist.md`](docs/releases/v0.9-merge-readiness-checklist.md)，tag readiness checklist 见 [`docs/releases/v0.9-tag-readiness-checklist.md`](docs/releases/v0.9-tag-readiness-checklist.md)。v1.0 Batch 0 的规划 ADR 见 [`docs/decisions/0045-v1.0-douyin-user-test-release-planning.md`](docs/decisions/0045-v1.0-douyin-user-test-release-planning.md)，规划文档见 [`docs/plans/v1.0-douyin-user-test-release-plan.md`](docs/plans/v1.0-douyin-user-test-release-plan.md)。v1.0 Batch 1 的 OAuth boundary / callback contract ADR 见 [`docs/decisions/0046-v1.0-oauth-boundary-callback-contract.md`](docs/decisions/0046-v1.0-oauth-boundary-callback-contract.md)，callback contract 见 [`docs/contracts/v1.0-douyin-oauth-callback-contract.md`](docs/contracts/v1.0-douyin-oauth-callback-contract.md)，contract test matrix 见 [`docs/testing/v1.0-oauth-callback-contract-test-matrix.md`](docs/testing/v1.0-oauth-callback-contract-test-matrix.md)。v1.0 Batch 2 的 OAuth state storage / anti-replay ADR 见 [`docs/decisions/0047-v1.0-oauth-state-storage-anti-replay.md`](docs/decisions/0047-v1.0-oauth-state-storage-anti-replay.md)，state storage contract 见 [`docs/contracts/v1.0-douyin-oauth-state-storage-contract.md`](docs/contracts/v1.0-douyin-oauth-state-storage-contract.md)，state storage test matrix 见 [`docs/testing/v1.0-oauth-state-storage-test-matrix.md`](docs/testing/v1.0-oauth-state-storage-test-matrix.md)。v1.0 Batch 3 的 token exchange boundary ADR 见 [`docs/decisions/0048-v1.0-token-exchange-boundary-fake-gated.md`](docs/decisions/0048-v1.0-token-exchange-boundary-fake-gated.md)，token exchange boundary contract 见 [`docs/contracts/v1.0-douyin-token-exchange-boundary-contract.md`](docs/contracts/v1.0-douyin-token-exchange-boundary-contract.md)，test matrix 见 [`docs/testing/v1.0-token-exchange-boundary-test-matrix.md`](docs/testing/v1.0-token-exchange-boundary-test-matrix.md)。v1.0 Batch 4 的 credential storage boundary ADR 见 [`docs/decisions/0049-v1.0-credential-reference-encrypted-storage-design.md`](docs/decisions/0049-v1.0-credential-reference-encrypted-storage-design.md)，credential storage boundary contract 见 [`docs/contracts/v1.0-douyin-credential-storage-boundary-contract.md`](docs/contracts/v1.0-douyin-credential-storage-boundary-contract.md)，test matrix 见 [`docs/testing/v1.0-credential-storage-boundary-test-matrix.md`](docs/testing/v1.0-credential-storage-boundary-test-matrix.md)。

v1.0 Batch 5 的 real provider feature flag / kill switch ADR 见 [`docs/decisions/0050-v1.0-real-provider-feature-flag-kill-switch.md`](docs/decisions/0050-v1.0-real-provider-feature-flag-kill-switch.md)，contract 见 [`docs/contracts/v1.0-real-provider-feature-flag-kill-switch-contract.md`](docs/contracts/v1.0-real-provider-feature-flag-kill-switch-contract.md)，test matrix 见 [`docs/testing/v1.0-real-provider-feature-flag-kill-switch-test-matrix.md`](docs/testing/v1.0-real-provider-feature-flag-kill-switch-test-matrix.md)。v1.0 Batch 6 的 user-confirmed publish intent workflow ADR 见 [`docs/decisions/0051-v1.0-user-confirmed-publish-intent-workflow.md`](docs/decisions/0051-v1.0-user-confirmed-publish-intent-workflow.md)，contract 见 [`docs/contracts/v1.0-user-confirmed-publish-intent-contract.md`](docs/contracts/v1.0-user-confirmed-publish-intent-contract.md)，test matrix 见 [`docs/testing/v1.0-user-confirmed-publish-intent-test-matrix.md`](docs/testing/v1.0-user-confirmed-publish-intent-test-matrix.md)。v1.0 Batch 7 的 guarded real publish adapter ADR 见 [`docs/decisions/0052-v1.0-real-publish-adapter-guarded-implementation.md`](docs/decisions/0052-v1.0-real-publish-adapter-guarded-implementation.md)，contract 见 [`docs/contracts/v1.0-real-publish-adapter-guarded-contract.md`](docs/contracts/v1.0-real-publish-adapter-guarded-contract.md)，test matrix 见 [`docs/testing/v1.0-real-publish-adapter-guarded-test-matrix.md`](docs/testing/v1.0-real-publish-adapter-guarded-test-matrix.md)。v1.0 Batch 8 的 publish status reconciliation ADR 见 [`docs/decisions/0053-v1.0-publish-status-reconciliation.md`](docs/decisions/0053-v1.0-publish-status-reconciliation.md)，contract 见 [`docs/contracts/v1.0-publish-status-reconciliation-contract.md`](docs/contracts/v1.0-publish-status-reconciliation-contract.md)，test matrix 见 [`docs/testing/v1.0-publish-status-reconciliation-test-matrix.md`](docs/testing/v1.0-publish-status-reconciliation-test-matrix.md)。v1.0 Batch 9 的 limited metrics read guarded foundation ADR 见 [`docs/decisions/0054-v1.0-limited-metrics-read-guarded-foundation.md`](docs/decisions/0054-v1.0-limited-metrics-read-guarded-foundation.md)，contract 见 [`docs/contracts/v1.0-limited-metrics-read-guarded-contract.md`](docs/contracts/v1.0-limited-metrics-read-guarded-contract.md)，test matrix 见 [`docs/testing/v1.0-limited-metrics-read-guarded-test-matrix.md`](docs/testing/v1.0-limited-metrics-read-guarded-test-matrix.md)。v1.0 Batch 10 的 user test readiness / release candidate ADR 见 [`docs/decisions/0055-v1.0-user-test-readiness-release-candidate.md`](docs/decisions/0055-v1.0-user-test-readiness-release-candidate.md)，RC checklist 见 [`docs/releases/v1.0-user-test-rc-checklist.md`](docs/releases/v1.0-user-test-rc-checklist.md)，closure audit 见 [`docs/releases/v1.0-rc-closure-audit.md`](docs/releases/v1.0-rc-closure-audit.md)，tag readiness checklist 见 [`docs/releases/v1.0-tag-readiness-checklist.md`](docs/releases/v1.0-tag-readiness-checklist.md)，merge readiness checklist 见 [`docs/releases/v1.0-merge-readiness-checklist.md`](docs/releases/v1.0-merge-readiness-checklist.md)，release notes draft 见 [`docs/releases/v1.0-user-test-release-notes-draft.md`](docs/releases/v1.0-user-test-release-notes-draft.md)，PR draft 见 [`docs/releases/v1.0-pr-description-draft.md`](docs/releases/v1.0-pr-description-draft.md)，user test guide 见 [`docs/testing/v1.0-user-test-guide.md`](docs/testing/v1.0-user-test-guide.md)，rollback runbook 见 [`docs/operations/v1.0-user-test-rollback-disablement.md`](docs/operations/v1.0-user-test-rollback-disablement.md)，RC test matrix 见 [`docs/testing/v1.0-user-test-rc-test-matrix.md`](docs/testing/v1.0-user-test-rc-test-matrix.md)。
...
当前 v1.0 工作线基于 v0.9.0 release commit `0f5263452b65077f2c70c82e506944dd46e60e96`。v1.0 已推进到 Batch 10 user test readiness / release candidate 阶段，用于收口 Batch 0-9 的 local-only / metadata-only / guarded foundation 验收材料、风险边界、测试矩阵、release notes / PR draft、user test guide 和 rollback / disablement runbook；本阶段仍未启用真实 provider，也仍未开始真实 OAuth、OAuth URL、真实 token exchange、真实 token storage、真实 credential storage、真实上传、真实发布、排期发布、真实 Douyin 状态查询或真实指标读取实现。当前仓库仍不接真实 Douyin，不实现 OAuth，不保存 token，不抓取真实指标，不查询真实发布状态，不上传、不发布、不排期发布，也不适合作为生产级真实平台集成使用。

v1.0 Batch 10 新增 user test readiness / release candidate package，只新增文档、运行手册、测试矩阵和验证脚本，不新增真实平台业务能力。Batch 10 不创建正式 v1.0 tag，不创建或修改 `v1.0.0` tag，不启用真实 provider，不创建 OAuth URL，不新增 OAuth start route，不新增 OAuth callback route，不做真实 token exchange，不保存真实 token / secret / credential / authorization code / raw OAuth state / OAuth state value，不新增 frontend OAuth UI，不调用 Douyin API 或业务外部服务，不上传、不真实发布、不排期发布、不查询真实 Douyin 状态、不抓取真实 Douyin 指标。后续真实状态查询和真实指标读取必须等后续独立批次、ADR、tests、安全扫描、真实 OAuth、credential readiness、平台权限、用户授权、app review、rate limit 和 audit 验收完成后才能实现。v1.0 不是生产商用版本，不等于 v1.5 Minimum Production Release，也不等于 v2.0 Multi-Tenant SaaS Commercial Release。

## 后续路线

当前已发布版本是 `v0.9.0 - Douyin Provider POC / Sandbox Integration`。v1.0 已进入 Douyin Integration User Test Release 的 Batch 10 user test readiness / release candidate 阶段，但尚未启用真实 provider，也尚未开始真实 OAuth runtime、真实 token exchange、真实 credential storage、真实发布、真实状态查询或真实指标读取。后续路线从 v1.0 小范围用户测试逐步扩展到 v1.5 直接客户受控商用目标，再到 v2.0 面向客户的客户 SaaS 商用目标：
...
- v1.0 Douyin Integration User Test Release：当前进入 Batch 10 user test readiness / release candidate package，用于收口 Batch 0-9 的本地 guarded foundation、RC checklist、release notes draft、PR draft、user test guide、rollback / disablement runbook、RC test matrix 和验证脚本。目标仍是验证真实 Douyin 授权、发布、状态查询和最小指标回流是否可行；本批不创建正式 release tag，不启用真实 provider，不实现真实 OAuth runtime、真实 token exchange、真实 token storage、真实 credential storage、真实上传、真实发布、排期发布、真实状态查询或真实指标读取。v1.0 不是生产商用版本，也不承诺 SLA、批量商用或多租户 SaaS。
...
- 在项目详情页基于同一项目内已 approved 的 `Review Draft` 和本地 media preflight 显式确认创建 metadata-only `PublishIntent`，查看发布意图列表与状态，并取消本地 active intent；创建意图不会上传、发布或调用 Douyin。
- 旧的待确认 `PublishIntent` 兼容路径仍可确认并创建 1 条本地 `not_started` 的 `PublicationRecord` placeholder；当前不会执行真实平台动作。
