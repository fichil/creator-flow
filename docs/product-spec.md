...
本节描述 future roadmap，不是当前能力声明。当前 v0.9 只有 sandbox/mock workflow、registry / factory foundation、sandbox-only backend API contract、frontend sandbox POC panel 和 roadmap / checklist 文档，不提供真实抖音连接、真实 OAuth、真实发布、生产级部署或多租户 SaaS。
