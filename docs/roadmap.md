...
状态：v0.3 Batch 3 已实现 backend-only Subtitle Domain Foundation；当前只生成 render job、fake render artifact metadata、subtitle draft metadata 和 subtitle cues，不生成真实 MP4、音频或字幕文件。
