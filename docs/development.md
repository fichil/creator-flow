...
- 未实现真实平台指标抓取、真实 MetricsProvider、定时指标同步、独立 analytics 页面、真实平台 dashboard 或数据分析推荐算法；当前只有项目详情页 fake/local metrics snapshots workflow。
